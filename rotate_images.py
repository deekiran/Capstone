...
if __name__ == '__main__':
    ...
    mirror_images('train-resized-256/', 1, lst_imgs_no_DR)


    # Rotate all images that have any level of DR
    print("Rotating 90 Degrees")
    rotate_images('train-resized-256/', 90, lst_imgs_DR)

    print("Rotating 120 Degrees")
    rotate_images('train-resized-256/', 120, lst_imgs_DR)

    print("Rotating 180 Degrees")
    rotate_images('train-resized-256/', 180, lst_imgs_DR)

    print("Rotating 270 Degrees")
    rotate_images('train-resized-256/', 270, lst_imgs_DR)

    print("Mirroring DR Images")
    mirror_images('train-resized-256/', 0, lst_imgs_DR)
